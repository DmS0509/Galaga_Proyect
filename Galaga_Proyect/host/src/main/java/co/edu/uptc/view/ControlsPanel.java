...
public class ControlsPanel extends JFrame {
    ...
    private static final String WASD_IMAGE = "/Images/wasd.png";
    private static final String SPACE_IMAGE = "/Images/espace.png";
    private static final String ARROWS_IMAGE = "/Images/flechas.png";
    private static final String SHIFT_IMAGE = "/Images/shift derecho.png";
